...
Принцип работы: Арудино выступает электронным редуктором между шпинделем и УДГ. Импульсы с энкодера (установленного на шпинделе) обрабатываются и преобразуются (согласно требуемого коэффициента редукции) в сигналы для шагового двигателя (установленного на УДГ). 
